 ...
 * it, it is just made to be a help if you are having a hard time generating files. It is not
 * commented so if you want an explanation you can come see me in office hours or send me a message
 * in canvas.
 * </P>
 *
 * <p>
 * My suggestion is to use this file to generate some random data then modify it slightly to test an
 * edge case. That way you have several other flights your algorithm will have to check as well as
 * the correct one.
 * </p>
 *
 * <p>
 * <b>USAGE:</b> You can use this class just by changing the commented global variables at the top
 * of the file. For students interested in what was done in lab with the command line you can also
 * compile it with <code>javac</code> and give it 3 command-line parameters: (1)The number of edges
 * you want in the graph, (2)the number of nodes in the graph, and (3)the name of the file for the
 * .csv file to output to. Keep in mind dense graphs will have shorter paths and sparce graphs may
 * not have paths to every node.
 * </p>
 *
